import 'package:card_scanner/base/theme/card_scanner_theme.dart';
import 'package:card_scanner/base/theme/design_system.dart';
import 'package:card_scanner/l10n/l10n.dart';
  ...
  Themes? theme,
    ...
    pumpDeviceBuilderWithMaterialApp(
      ...
      theme: theme == Themes.light
          ? CardScannerTheme.buildTheme(DesignSystem.light())
          : CardScannerTheme.buildTheme(DesignSystem.dark()),
    );
